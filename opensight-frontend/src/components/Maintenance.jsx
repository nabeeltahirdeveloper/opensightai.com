        ...
        <div className="text-center">
          ...
          <div className="space-y-4 text-gray-200 text-lg leading-relaxed">
            <p className="text-xl text-white font-semibold">
              We sincerely apologize for the inconvenience - our website is currently undergoing important MID updates to improve performance and reliability.
            </p>
            
            <p>
              During this maintenance window, the entire website will be temporarily unavailable.
            </p>
            
            <p className="text-yellow-300 font-medium">
              We expect to be fully back online within 48 hours.
            </p>
            ...
            <p className="pt-4 border-t border-white/20">
              If you need urgent assistance, please feel free to contact our support team.
            </p>
          </div>
